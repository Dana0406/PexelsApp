package com.example.pexelsapp.presentation.utils

object Constants {
    const val IMAGE_SAVED_MESSAGE = "Photo was saved. Press again to unsave"
    const val IMAGE_UNSAVED_MESSAGE = "Photo was unsaved"
